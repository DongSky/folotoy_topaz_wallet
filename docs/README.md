...
| [Card Wallet application](development/card-wallet.md) | Android/BLE card import, receiving codes, balances, estimates, and device controls |
| [Card Wallet redesign proposal](development/card-wallet-redesign.md) | Corrected stock-firmware scope, mnemonic import, and the visual redesign |
