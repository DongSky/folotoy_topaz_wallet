...
| [名片钱包应用](development/card-wallet.zh_CN.md) | Android/BLE 名片导入、收款码、余额估值与设备操作 |
| [名片钱包重设计提案](development/card-wallet-redesign.zh_CN.md) | 修正后的原版固件范围、助记词导入及视觉重设计 |
...
项目基础、协议参考和主要依赖见[托帕钱包致谢](acknowledgements.zh_CN.md)。
